...
export default function LoginPage() {
  ...
  const [error, setError] = useState<string | null>(
    urlError === "auth_callback_failed" ? "認証に失敗しました。もう一度お試しください。" : null
  );
  ...
  return (
    <div className="bg-slate-800/50 backdrop-blur border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
      <div className="mb-6">
        ...
        <p className="text-slate-400 text-sm">アカウントにサインインしてください</p>
      </div>
      ...
      <div className="relative my-5">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="px-2 bg-slate-800/50 text-slate-500">または</span>
        </div>
      </div>
