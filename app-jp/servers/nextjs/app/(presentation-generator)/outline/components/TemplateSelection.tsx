    ...
    <div className="space-y-[30px] mb-4">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-base font-semibold text-gray-900 font-syne">カスタム</h3>
        </div>
        {customTemplateCards}
      </div>
      {/* In Built Templates */}
      <div>
        <h3 className="text-base font-semibold text-gray-900 mb-3 font-syne">組み込み</h3>
