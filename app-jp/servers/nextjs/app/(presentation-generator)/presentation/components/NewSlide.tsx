  ...
  useEffect(() => {
    ...
    const fetchLayouts = async () => {
      ...
      if (isCustomTemplate) {
        ...
        const templateDetails = await getCustomTemplateDetails(customTemplateId, "カスタムテンプレート", "ユーザー作成テンプレート");
    ...
    return (
      <div className="my-6 w-full bg-gray-50 p-8 max-w-[1280px]">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl font-semibold">スライドレイアウトを選択</h2>
          <X
