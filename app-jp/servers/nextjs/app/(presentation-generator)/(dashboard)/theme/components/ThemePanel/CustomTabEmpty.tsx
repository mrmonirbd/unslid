    ...
    return (
        <div
            ...
            <div className='px-5 py-4 bg-white flex items-center gap-4 border-t border-[#EDEEEF]'>
                ...
                <div>
                    <h4 className='text-[#191919] text-sm font-semibold '>テーマを作成</h4>
                    <p className='flex text-[#808080] text-sm  font-medium items-center gap-2'>カラーから <ArrowRight className='w-3 h-3' /> フォントへ</p>
                </div>
