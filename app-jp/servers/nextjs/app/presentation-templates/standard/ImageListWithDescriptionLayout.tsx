...
const Schema = z.object({
  ...
  title: z.string().min(10).max(50).default("プロフェッショナルチーム").meta({
  ...
  cards: z.array(z.object({
    ...
    role: z.string().min(20).max(50).default("ブランドと成長を専門とするマーケティングスペシャリスト").meta({
    ...
    {
      name: "Sam Rawlings",
      role: "ブランドと成長を専門とするマーケティングスペシャリスト",
      photo: {
