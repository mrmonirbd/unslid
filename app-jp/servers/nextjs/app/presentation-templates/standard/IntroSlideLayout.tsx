...
const Schema = z.object({
    ...
    title: z.string().min(12).max(30).default("はじめに：ピッチデッキ").meta({
    ...
    paragraph: z.string().min(50).max(200).default("金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。").meta({
...
const dynamicSlideLayout: React.FC<LayoutProps> = ({ data: slideData }) => {
    const title = slideData?.title || "はじめに：ピッチデッキ"
