...
const CardSchema = z.object({
    title: z.string().min(6).max(18).default("調査").meta({
    ...
    description: z.string().min(1).max(50).default("テクノロジーセクターを優先します。").meta({
...
const Schema = z.object({
    ...
    title: z.string().min(20).max(68).default("卓越性を追求するビジョンと戦略").meta({
        description: "Main slide title. Max 10 words",
    }),
    description: z.string().min(70).max(200).default("金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、新規パイプラインを目標とします。").meta({
    ...
    cards: z.array(CardSchema).min(1).max(4).default([
        ...
        { title: "開発", value: 80, unit: "K", description: "テクノロジーセクターを優先します。" },
    ]).meta({
    ...
    topBar: { marker: "2" },
    title: "卓越性を追求するビジョンと戦略",
    description: "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、新規パイプラインを目標とします。",
    cards: [
        { title: "調査", value: 67, unit: "K", description: "テクノロジーセクターを優先します。" },
        { title: "運用", value: 42, unit: "M", description: "テクノロジーセクターを優先します。" },
        { title: "効率", value: 67, unit: "%", description: "テクノロジーセクターを優先します。" },
        { title: "開発", value: 80, unit: "K", description: "テクノロジーセクターを優先します。" },
    ],
