...
export const Schema = z.object({
    title: z.string().max(20).describe('The main heading of the slide').default('タイムライン'),
    milestones: z.array(z.object({
        ...
        { year: '2017', description: 'ここに重要なマイルストーンの説明を入力してください。' },
        { year: '2018', description: 'ここに重要なマイルストーンの説明を入力してください。' },
        { year: '2019', description: 'ここに重要なマイルストーンの説明を入力してください。' },
        { year: '2020', description: 'ここに重要なマイルストーンの説明を入力してください。' },
        { year: '2021', description: 'ここに重要なマイルストーンの説明を入力してください。' },
        { year: '2022', description: 'ここに重要なマイルストーンの説明を入力してください。' },
        { year: '2023', description: 'ここに重要なマイルストーンの説明を入力してください。' },
        { year: '2024', description: 'ここに重要なマイルストーンの説明を入力してください。' },
