...
export const Schema = z.object({
    title: z.string().max(50).describe('The main heading of the slide').default('市場投入戦略'),
    description: z.string().max(400).describe('Supporting description text for the slide').default('金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。'),
    sections: z.array(z.object({
    ...
    })).max(3).describe('Column sections containing bullet points').default([
        {
            heading: '有料チャネル',
            bulletPoints: [
                { title: 'LinkedIn広告:', description: 'ABMリターゲティング' },
                { title: 'Google広告:', description: 'インテントキャプチャ' },
                { title: 'ディスプレイ:', description: 'ブランド認知' }
            ]
        },
        {
            heading: 'オーガニックチャネル',
            bulletPoints: [
                { title: 'SEO:', description: 'ソートリーダーシップ' },
                { title: 'コンテンツ:', description: '教育' },
                { title: 'ソーシャル:', description: 'コミュニティ' }
            ]
        },
        {
            heading: 'パートナーシップ',
            bulletPoints: [
                { title: 'イベント:', description: 'ネットワーク構築' },
                { title: 'コマーケ:', description: 'リーチ拡大' },
                { title: '紹介:', description: '信頼構築' },
                { title: '紹介:', description: '信頼構築' },
                { title: '紹介:', description: '信頼構築' },
                { title: '紹介:', description: '信頼構築' },
            ]
