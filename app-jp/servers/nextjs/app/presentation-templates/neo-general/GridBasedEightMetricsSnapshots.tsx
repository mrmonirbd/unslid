...
export const Schema = z.object({
    title: z.string().max(30).describe('The main heading of the slide').default('キャンペーン実績スナップショット'),
    ...
    cards: z.array(z.object({
        ...
        .describe('Array of metric cards for the grid').default([
            { metric: '342 SQL', label: 'エンタープライズABMローンチ', subtext: '28% コンバージョン率', isHighlighted: false },
            { metric: '$1.8M パイプライン', label: '製品機能リリース', subtext: '4.7X ROAS', isHighlighted: false },
            { metric: '156 件成立', label: '業界サミットスポンサーシップ', subtext: '42% ミーティング率', isHighlighted: true },
            { metric: '156 件成立', label: '業界サミットスポンサーシップ', subtext: '42% ミーティング率', isHighlighted: false },
            { metric: '342 SQL', label: 'エンタープライズABMローンチ', subtext: '28% コンバージョン率', isHighlighted: false },
            { metric: '$1.8M パイプライン', label: '製品機能リリース', subtext: '4.7X ROAS', isHighlighted: false },
