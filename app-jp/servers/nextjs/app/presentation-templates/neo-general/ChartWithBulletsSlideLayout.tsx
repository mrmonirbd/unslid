...
const chartWithBulletsSlideSchema = z.object({
    title: z.string().min(3).max(40).default('市場規模').meta({
        description: "Main title of the slide",
    }),
    description: z.string().min(10).max(150).default('企業は時代遅れの技術と増大するコストという課題に直面しており、競争市場での効率性と成長が制限されています。').meta({
    ...
    bulletPoints: z.array(z.object({
        ...
        {
            title: 'ターゲット市場規模',
            description: '企業はTAMを使って将来の拡張や投資計画を立てます。',
            icon: {
        ...
        {
            title: 'サービス提供可能市場',
            description: '販売活動に向けたより測定可能な市場セグメントを示します。',
            icon: {
                __icon_url__: 'https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/chart-line-up-bold.svg',
        ...
        {
            title: '獲得可能市場',
            description: '市場に応じた開発戦略の立案をサポートします。',
            icon: {
                __icon_url__: 'https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/chart-line-up-bold.svg',
...
const ChartWithBulletsSlideLayout: React.FC<ChartWithBulletsSlideLayoutProps> = ({ data: slideData }) => {
    ...
    const renderChart = () => {
        ...
        switch (chartType) {
            ...
            default:
                return <div className="flex items-center justify-center h-full text-gray-500">サポートされていないグラフタイプ</div>;
        }
    };
                ...
                <div className="flex h-full px-8 sm:px-12 lg:px-20 pt-8 pb-8">
                    ...
                    <div className="flex-1 flex flex-col pr-8">
                        ...
                        <p style={{ color: "var(--background-text,#4b5563)" }} className="text-base text-gray-700 leading-relaxed mb-4">
                            {slideData?.description || '企業は時代遅れの技術と増大するコストという課題に直面しており、競争市場での効率性と成長が制限されています。'}
                        </p>
