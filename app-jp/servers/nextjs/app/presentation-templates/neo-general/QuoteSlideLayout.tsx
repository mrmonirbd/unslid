...
const quoteSlideSchema = z.object({
    heading: z.string().min(3).max(60).default('名言').meta({
        description: "Heading text of the slide",
    }),
    quote: z.string().min(10).max(200).default('成功は永遠ではなく、失敗は致命的でもない。重要なのは、続ける勇気だ。夢の美しさを信じる者に未来は属する。').meta({
                    ...
                    <div className="text-center space-y-8 max-w-4xl mx-auto">
                        ...
                        <div className="space-y-6">
                            ...
                            <blockquote style={{ color: "var(--background-text,#ffffff)" }} className="text-xl sm:text-2xl lg:text-3xl font-medium text-white leading-relaxed italic">
                                "{slideData?.quote || '成功は永遠ではなく、失敗は致命的でもない。重要なのは、続ける勇気だ。夢の美しさを信じる者に未来は属する。'}"
                            </blockquote>
