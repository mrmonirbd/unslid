...
export const Schema = z.object({
    title: z.string().max(21).describe('The main heading of the slide').default('支出とROI概要'),
    description: z.string().max(100).describe('Supporting description text for the slide').default('金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。'),
    chart: z.object({
        ...
        categories: ['1月', '2月', '3月'],
        series: [
            { name: '収益', color: '#8910FA', values: [520, 660, 985] },
            { name: '支出', color: '#457EE5', values: [140, 245, 400] },
        ],
    ...
    metrics: z.array(
        ...
        { value: '$1,800K', label: '計画合計' },
        { value: '$1,800K', label: '実績合計' },
        { value: '$1,800K', label: '計画合計' },
        { value: '$1,800K', label: '実績合計' },
        { value: '$1,800K', label: '計画合計' },
        { value: '$1,800K', label: '実績合計' },
