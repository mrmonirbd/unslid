...
export const Schema = z.object({
    ...
    cards: z.array(z.object({
        ...
        {
            heading: 'エンタープライズABMが3.2倍高いコンバージョン率を実現',
            description: '企業をターゲットにしたアカウントベースのキャンペーン。',
        },
        {
            heading: 'コンテンツと有料SNSの組み合わせが最高品質のリードを生成',
            description: '統合キャンペーンからのリードは47%速くクローズ。',
        },
        {
            heading: 'モバイル最適化でモバイルコンバージョンが向上',
            description: 'モバイルに特化したランディングページの再設計。',
        },
        {
            heading: 'エンタープライズABMが3.2倍高いコンバージョン率を実現',
            description: '企業をターゲットにしたアカウントベースのキャンペーン。',
