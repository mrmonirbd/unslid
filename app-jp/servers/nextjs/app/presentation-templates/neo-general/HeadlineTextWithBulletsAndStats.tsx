...
export const Schema = z.object({
    ...
    bulletPoints: z.array(z.string().max(160)).max(6).describe('List of bullet point text items').default([
        '有料検索とメールキャンペーンの好調により、収益目標を12%上回りました（$2.4M対目標$2.1M）',
        'マーケティングが総パイプライン価値の68%に影響（前四半期の52%から増加）',
        '有料検索ROIが5.8x（4.1xから）に向上し、最も効率的なチャンネルとなりました',
        'マーケティングが総パイプライン価値の68%に影響（前四半期の52%から増加）',
        '有料検索ROIが5.8x（4.1xから）に向上し、最も効率的なチャンネルとなりました',
        'マーケティングが総パイプライン価値の68%に影響（前四半期の52%から増加）',
        '有料検索ROIが5.8x（4.1xから）に向上し、最も効率的なチャンネルとなりました',
    ...
    metrics: z.array(z.object({
        ...
        { value: '8,450', label: 'リード数' },
        { value: '2,680', label: 'MQL数' },
        { value: '$2400', label: '収益' }
    ])
});
