...
export const Schema = z.object({
    title: z.string().max(25).describe('The main heading of the slide').default('重要インサイトと学び'),
    insightTitle: z.string().max(63).describe('Heading for the highlighted card').default('コンテンツと有料SNSの組み合わせが最高品質のリードを生成'),
    insightDescription: z.string().max(99).describe('Description text for the highlighted card').default('統合キャンペーンからのリードはクローズ期間が47%短縮し、平均契約額が28%高くなりました。')
});
