...
export const Schema = z.object({
    title: z.string().min(3).max(50).default('データ分析ダッシュボード').meta({
        description: "Main title of the slide",
    }),
    description: z.string().min(10).max(200).default('複数のデータ次元にわたる主要指標とパフォーマンス指標の総合的な概要。').meta({
    ...
    charts: z.array(ChartItemSchema).min(1).max(6).default([
        ...
        },
        {
            ...
            data: [
                { name: '営業', value: 87 },
                { name: 'マーケティング', value: 72 },
                { name: 'エンジニアリング', value: 95 },
                { name: 'サポート', value: 68 },
            ],
            colorPalette: 'sunset',
        },
        {
            ...
            type: 'bar-clustered',
            data: [
                { name: 'Q1', values: { '製品A': 45, '製品B': 62 } },
                { name: 'Q2', values: { '製品A': 58, '製品B': 71 } },
                { name: 'Q3', values: { '製品A': 72, '製品B': 65 } },
            ],
            series: ['製品A', '製品B'],
            colorPalette: 'vibrant',
        },
        {
            ...
            type: 'bar-diverging',
            data: [
                { name: '品質', positive: 78, negative: 22 },
                { name: 'サービス', positive: 65, negative: 35 },
                { name: '価格', positive: 42, negative: 58 },
            ],
            series: ['満足', '不満'],
            colorPalette: 'professional',
        },
