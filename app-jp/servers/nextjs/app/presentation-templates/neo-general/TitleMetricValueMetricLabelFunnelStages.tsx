...
export const Schema = z.object({
    title: z.string().max(30).describe('The main heading of the slide').default('ファネルパフォーマンス'),
    metricValue: z.string().max(10).describe('Primary metric value displayed').default('0.24%'),
    metricLabel: z.string().max(100).describe('Label describing the metric').default('総合\n訪問 → 顧客'),
    funnelStages: z.array(z.object({
        ...
        { label: '訪問者', value: '124,500', conversionRate: '10%' },
        { label: 'リード', value: '12,450', conversionRate: '10%' },
        { label: 'マーケティング適格', value: '4,356', conversionRate: '35%' },
