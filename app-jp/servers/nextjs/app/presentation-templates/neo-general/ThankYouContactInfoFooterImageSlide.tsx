...
export const Schema = z.object({
    title: z.string().max(10).describe('The main heading of the slide').default('ありがとうございました'),
    description: z.string().max(120).describe('Supporting description text').default('私たちの小さなビジネスをご支援いただきありがとうございます！感謝を込めて、コード「CODE20」で次回のご注文から20%オフをお楽しみください。'),
    contactTitle: z.string().max(15).describe('Heading for the contact section').default('お問い合わせ'),
    phone: z.string().max(20).describe('Phone number text').default('+977-98000000'),
    email: z.string().max(30).describe('Email address text').default('contact@unslid.com'),
    website: z.string().max(30).describe('Website URL text').default('www.unslid.com'),
