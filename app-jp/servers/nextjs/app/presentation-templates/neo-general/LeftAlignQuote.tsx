...
export const Schema = z.object({
    title: z.string().describe('The main heading of the slide').max(20).default("名言"),
    quote: z.string().describe('Quotation text displayed').max(200).default("「成功は永遠ではなく、失敗は致命的でもない。重要なのは、続ける勇気だ。夢の美しさを信じる者に未来は属する。」"),
