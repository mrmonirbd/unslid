...
export const Schema = z.object({
    title: z.string().max(40).describe("The main title of the slide").default("グラフと説明・指標"),
    description: z.string().max(250).describe("The description of the slide").default("金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。"),
    metrics: z.array(z.object({
        ...
        { value: "85%", label: "主な課題：クライアント対応の遅延" },
        { value: "85%", label: "主な課題：クライアント対応の遅延" },
        { value: "85%", label: "主な課題：クライアント対応の遅延" },
        { value: "85%", label: "主な課題：クライアント対応の遅延" }
    ]),
    chart: z.object({
        ...
        title: "キャンペーンA",
        topLabel: "トップキャンペーン",
        bottomLabel: "エンゲージメント率",
        chartType: "bar",
        seriesNames: ["計画予算K", "実際予算K"],
        data: [
            { label: "有料SNS", value1: 520, value2: 485 },
            { label: "コンテンツ", value1: 380, value2: 412 },
            { label: "イベント", value1: 450, value2: 468 },
            { label: "SEO", value1: 280, value2: 276 }
        ]
    })
});
