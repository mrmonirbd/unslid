...
export const Schema = z.object({
    title: z.string().max(30).describe('The main title of the slide').default('プロセス / ワークフロー'),
    description: z.string().max(250).describe('A descriptive paragraph for the slide topic').default('金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。'),
    listItems: z.array(z.object({
    ...
    })).max(5).describe('A list of items with icons, headings, and descriptions').default([
        {
            ...
            heading: '2021',
            itemDescription: '議論したい内容について簡潔に説明してください。'
        },
        {
            icon: { __icon_url__: 'https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/checks-bold.svg', __icon_query__: 'checkmark' },
            heading: '2020',
