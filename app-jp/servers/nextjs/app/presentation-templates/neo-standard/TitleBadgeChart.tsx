...
export const Schema = z.object({
    title: z.string().max(10).describe('The main heading of the slide').default('棒グラフ'),
    badgeText: z.string().max(12).describe('The text displayed within the colored box').default('キャンペーンA'),
    topDescription: z.string().max(20).describe('The textual label at the top right of the chart').default('トップキャンペーン'),
    bottomDescription: z.string().max(25).describe('The textual label at the bottom right of the chart').default('エンゲージメント率'),
    ...
    graphData: z.object({
        ...
        columns: ["カテゴリ", "計画予算",],
        rows: [
            { label: "有料SNS", value1: 520, },
            { label: "コンテンツ", value1: 380, },
            { label: "イベント", value1: 450, },
            { label: "SEO", value1: 280, }
        ]
    })
});
