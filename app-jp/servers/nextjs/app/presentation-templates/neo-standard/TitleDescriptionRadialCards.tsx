...
export const Schema = z.object({
    title: z.string().describe("The main title of the slide").default("エグゼクティブサマリー"),
    description: z.string().describe("A brief overview or summary description").default("金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。"),
    cards: z.array(z.object({
        ...
        { heading: "調査", graph: { value: 1 }, footerText: "主な課題：クライアント対応の遅延" },
        { heading: "調査", graph: { value: 40 }, footerText: "主な課題：クライアント対応の遅延" },
        { heading: "調査", graph: { value: 60 }, footerText: "主な課題：クライアント対応の遅延" },
        { heading: "調査", graph: { value: 80 }, footerText: "主な課題：クライアント対応の遅延" },
        { heading: "調査", graph: { value: 30 }, footerText: "主な課題：クライアント対応の遅延" },
        { heading: "調査", graph: { value: 99 }, footerText: "主な課題：クライアント対応の遅延" },
    ]),
});
