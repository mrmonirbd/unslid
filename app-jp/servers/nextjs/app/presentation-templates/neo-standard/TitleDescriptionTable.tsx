...
export const Schema = z.object({
    title: z.string().max(10).describe("The main title of the slide").default("テーブル"),
    description: z.string().max(250).describe("The descriptive paragraph at the top right of the slide").default("金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。"),
    table: z.object({
