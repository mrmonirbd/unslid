...
export const Schema = z.object({
    title: z.string().max(40).describe('The main heading of the slide').default('画像と説明・指標'),
    description: z.string().max(150).describe('The secondary description text below the title').default('金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。$3.5M達成を目標とします。'),
