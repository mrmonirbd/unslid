...
const teamSlideSchema = z.object({
    title: z.string().min(3).max(40).default('私たちのチームメンバー').meta({
        description: "Main title of the slide",
    }),
    companyDescription: z.string().min(10).max(150).default('Ginyard International Co.は企業向けの革新的なデジタルソリューションの大手プロバイダーです。最先端の技術と戦略的パートナーシップを通じて、組織が目標を達成できるよう支援することが私たちのミッションです。').meta({
    ...
    teamMembers: z.array(teamMemberSchema).min(2).max(4).default([
        {
            name: 'Juliana Silva',
            position: 'CEO',
            description: '15年以上のデジタルトランスフォーメーションとビジネス成長の経験を持つ戦略リーダー。',
            image: {
        ...
        },
        {
            name: 'Daniel Gallego',
            position: 'CTO',
            description: 'スケーラブルなソリューションと革新的なソフトウェアアーキテクチャを専門とする技術の専門家。',
            image: {
                __image_url__: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80',
        ...
        },
        {
            name: 'Ketut Susilo',
            position: 'COO',
            description: '効率性、プロセス最適化、チーム開発に注力する運営リーダー。',
            image: {
        ...
        },
        {
            name: 'Anna Robertson',
            position: 'CMO',
            description: 'ブランド開発と顧客エンゲージメントの専門知識を持つマーケティングストラテジスト。',
            image: {
                ...
                <div className="relative z-10 flex h-full px-8 sm:px-12 lg:px-20 pt-12 pb-8">
                    ...
                    <div className="flex-1 flex flex-col justify-center pr-8 space-y-6">
                        ...
                        <p style={{ color: "var(--background-text,#4b5563)" }} className="text-base sm:text-lg text-gray-700 leading-relaxed">
                            {slideData?.companyDescription || 'Ginyard International Co.は企業向けの革新的なデジタルソリューションの大手プロバイダーです。最先端の技術と戦略的パートナーシップを通じて、組織が目標を達成できるよう支援することが私たちのミッションです。'}
                        </p>
                    </div>
