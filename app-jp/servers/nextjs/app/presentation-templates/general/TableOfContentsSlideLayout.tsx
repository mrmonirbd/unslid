...
const tableOfContentsSlideSchema = z.object({
    sections: z.array(z.object({
        ...
        { number: 1, title: "課題", pageNumber: "03" },
        { number: 2, title: "解決策", pageNumber: "04" },
        { number: 3, title: "製品概要", pageNumber: "05" },
        { number: 4, title: "市場規模", pageNumber: "06" },
        { number: 5, title: "市場の検証", pageNumber: "07" },
        { number: 6, title: "会社の実績", pageNumber: "08" },
        { number: 7, title: "製品パフォーマンス", pageNumber: "09" },
        { number: 8, title: "ビジネスモデル", pageNumber: "10" },
        { number: 9, title: "競合優位性", pageNumber: "11" },
        { number: 10, title: "チームメンバー", pageNumber: "12" }
    ]).meta({
