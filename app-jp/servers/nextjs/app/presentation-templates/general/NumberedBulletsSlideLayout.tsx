...
const numberedBulletsSlideSchema = z.object({
    title: z.string().min(3).max(40).default('市場の検証').meta({
    ...
    bulletPoints: z.array(z.object({
        ...
        {
            title: '顧客インサイト',
            description: '調査によると、78%の企業がデジタルソリューションへの投資を計画しており、85%がカスタマイズされたアプローチを好むことがわかりました。'
        },
        {
            title: 'パイロットプログラムの成功',
            description: '調査によると、78%の企業がデジタルソリューションへの投資を計画しており、85%がカスタマイズされたアプローチを好んでいます。'
        },
        {
            title: 'パイロットプログラムの成功',
            description: '調査によると、78%の企業がデジタルソリューションへの投資を計画しており、85%がカスタマイズされたアプローチを好んでいます。'
