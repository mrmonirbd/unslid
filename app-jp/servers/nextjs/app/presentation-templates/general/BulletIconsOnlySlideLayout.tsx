...
const bulletIconsOnlySlideSchema = z.object({
    title: z.string().min(3).max(40).default('ソリューション').meta({
    ...
    bulletPoints: z.array(z.object({
        ...
        {
            title: 'カスタムソフトウェア',
            subtitle: 'プロセスを最適化し、効率を高めるためのカスタムソフトウェアを開発します。',
            icon: {
        ...
        {
            title: 'デジタルコンサルティング',
            subtitle: '最新テクノロジーを活用するよう組織をサポートします。',
            icon: {
        ...
        {
            title: 'サポートサービス',
            subtitle: 'ビジネスが適応し、パフォーマンスを維持できるよう継続的なサポートを提供します。',
            icon: {
        ...
        {
            title: 'スケーラブルマーケティング',
            subtitle: 'データドリブンな戦略でビジネスのリーチとエンゲージメントを拡大します。',
            icon: {
                __icon_url__: 'https://presenton-public.s3.ap-southeast-1.amazonaws.com/static/icons/bold/code-bold.svg',
