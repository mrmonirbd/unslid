...
const bulletWithIconsSlideSchema = z.object({
    title: z.string().min(3).max(40).default('課題').meta({
        description: "Main title of the slide",
    }),
    description: z.string().max(150).default('企業は時代遅れの技術と増大するコストという課題に直面しており、競争市場での効率性と成長が制限されています。').meta({
    ...
    bulletPoints: z.array(z.object({
        ...
        {
            title: '非効率性',
            description: '企業はニーズに合うデジタルツールを見つけるのに苦労しており、業務の遅延を引き起こしています。',
            icon: {
        ...
        {
            title: '高コスト',
            description: '古いシステムは経費を増加させ、中小企業は市場拡大に苦労しています。',
            icon: {
