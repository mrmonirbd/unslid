    ...
    .default([
      {
        name: "Sarah Johnson",
        description:
          "15年以上のテクノロジーとビジネス開発の経験を持つ戦略リーダー。Fortune 500企業の元VP。",
        image: {
          __image_url__:
      ...
      },
      {
        name: "Michael Chen",
        description:
          "スケーラブルなアーキテクチャとAIソリューションを専門とする技術の専門家。MITのコンピュータサイエンス博士。",
        image: {
          __image_url__:
      ...
      },
      {
        ...
        description:
          "B2B市場でハイパフォーマンスチームを構築し、収益成長を牽引した実績を持つセールスリーダー。",
        image: {
          __image_url__:
      ...
      },
      {
        name: "David Kim",
        description:
          "ユーザーエクスペリエンスと市場主導のソリューションに注力するプロダクトストラテジスト。大手テクノロジー企業の元プロダクトマネージャー。",
        image: {
          __image_url__:
