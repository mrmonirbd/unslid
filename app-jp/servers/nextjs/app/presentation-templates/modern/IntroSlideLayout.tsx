...
const introPitchDeckSchema = z.object({
  title: z.string().min(2).max(15).default("ピッチデック").meta({
  ...
  description: z
    ...
    .min(1)
    .max(200)
    .default("ここに短いサブタイトルまたは説明を追加してください。ここに短いサブタイトルまたは説明を追加してください。")
    .meta({
  ...
  introCard: z
    .object({
      ...
      date: z.string().min(1).max(60).default("2025年12月"),
    })
    .default({ enabled: true, name: "John Doe", date: "2025年12月" })
