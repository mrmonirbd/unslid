...
const bulletWithIconsSlideSchema = z.object({
  title: z.string().min(3).max(20).default("課題").meta({
  ...
  description: z
    ...
    .max(200)
    .default(
      "問題はさらに詳細に議論される必要があります。なぜなら、この問題は製品やサービスの初期開発および意思決定の主要な基盤となるからです。明確に定義された問題がなければ、焦点が定まらず、管理されておらず、関連性の低い業務に影響を与えます。",
    )
    .meta({
    ...
    .default([
      {
        title: "非効率性",
        description:
          "企業はニーズに合うデジタルツールを見つけるのに苦労しており、業務の遅延を引き起こしています。",
        icon: {
          __icon_url__:
      ...
      },
      {
        title: "高コスト",
        description:
          "古いシステムは経費を増加させ、中小企業は市場拡大に苦労しています。",
        icon: {
          __icon_url__:
