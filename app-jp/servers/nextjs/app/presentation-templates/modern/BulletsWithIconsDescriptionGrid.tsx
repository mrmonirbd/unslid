...
const bulletWithIconsDescriptionGridSlideSchema = z.object({
  ...
  title: z.string().min(3).max(25).default("ビジネスの課題").meta({
  ...
  mainDescription: z
    ...
    .max(300)
    .default(
      "以前に説明・特定された問題を解決するソリューションを提供することを示します。私たちのソリューションが有効性・効率性の価値を守り、市場と社会の状況に高度に関連していることを確認してください。",
    )
    .meta({
  ...
  sections: z
    ...
    .default([
      ...
      {
        title: "SEM",
        description: "精確なデータと分析によって推進されています。",
        icon: {
      ...
      {
        title: "エンドユーザー",
        description: "実際のユーザーへの影響に焦点を当てています。",
        icon: {
