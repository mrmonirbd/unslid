...
export const Schema = z.object({
    title: z.string().max(30).describe('The main heading of the slide').default('KPIスナップショット'),
    kpiCards: z.array(z.object({
        ...
        { topLabel: '収益が増加', bottomLabel: '15%', isHighlighted: false, isValueFirst: false },
        { topLabel: 'SNSエンゲージメントが成長', bottomLabel: '22%', isHighlighted: true, isValueFirst: false },
        { topLabel: '10', bottomLabel: 'プロジェクト完了', isHighlighted: false, isValueFirst: true },
        { topLabel: '10', bottomLabel: 'プロジェクト完了', isHighlighted: false, isValueFirst: true },
        { topLabel: '収益が増加', bottomLabel: '15%', isHighlighted: false, isValueFirst: false },
        { topLabel: 'SNSエンゲージメントが成長', bottomLabel: '22%', isHighlighted: true, isValueFirst: false },
        { topLabel: '10', topSuffix: '主要', bottomLabel: 'プロジェクト完了', isHighlighted: false, isValueFirst: true },
        { topLabel: '10', topSuffix: '主要', bottomLabel: 'プロジェクト完了', isHighlighted: false, isValueFirst: true },
    ]),
});
