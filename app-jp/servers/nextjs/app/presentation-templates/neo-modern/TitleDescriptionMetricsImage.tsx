...
export const Schema = z.object({
    title: z.string().max(25).describe("The main heading of the slide").default("タイトル・説明・指標・画像"),
    description: z.string().max(150).describe("Supporting description text").default("タイトル、説明、2×2の主要指標グリッド、右側の大きな縦型画像を備えたシンプルでプロフェッショナルなスライドです。"),
