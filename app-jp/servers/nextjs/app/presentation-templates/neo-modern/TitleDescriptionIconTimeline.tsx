...
export const Schema = z.object({
    title: z.string().max(40).describe('The main heading of the slide').default('プロセス / ワークフロー'),
    description: z.string().max(300).describe('Supporting description text').default('金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。'),
    processItems: z.array(z.object({
    ...
    })).max(5).describe('A list of up to 5 items').default([
        {
            ...
            heading: '2021',
            subDescription: '議論したい内容について簡潔に説明してください。議論したい内容について簡潔に説明してください。'
        },
        {
            ...
            heading: '2020',
            subDescription: '議論したい内容について簡潔に説明してください。'
        },
        {
