...
export const Schema = z.object({
    title: z.string().max(25).describe("The main heading of the slide").default("グラフと説明・指標"),
    description: z.string().max(180).describe("Supporting description text").default("金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。"),
    metricCards: z.array(z.object({
        ...
        { heading: "主な課題：クライアント対応の遅延", value: "85%" },
        { heading: "登録ユーザー総数", value: ">500 M" },
    ]),
    chartTitle: z.string().max(12).describe("Title text for the chart").default("キャンペーンA"),
    chartCategory: z.string().max(12).describe("Secondary label text").default("トップキャンペーン"),
    chartFooterLabel: z.string().max(15).describe("Footer label text for the chart").default("エンゲージメント率"),
    ...
    chartData: z.object({
        ...
        columns: ["計画予算", "実際予算"],
        rows: [
            { label: "有料SNS", value1: 920, value2: 485 },
            { label: "コンテンツマーケティング", value1: 380, value2: 412 },
            { label: "イベント・スポンサー", value1: 450, value2: 468 },
            { label: "SEO・オーガニック", value1: 280, value2: 276 }
        ]
    })
});
