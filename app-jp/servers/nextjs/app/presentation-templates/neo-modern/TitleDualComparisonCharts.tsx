...
export const Schema = z.object({
    title: z.string().max(50).describe("The main title of the slide").default("競合比較"),
    comparisonCards: z.array(z.object({
        ...
        {
            heading: "キャンペーンA",
            subHeading: "トップキャンペーン",
            footerText: "エンゲージメント率",
            chartType: "bar",
            chart: {
                columns: ["有料SNS", "コンテンツマーケティング", "イベント・スポンサー", "SEO・オーガニック"],
                rows: [
                    [{ label: "計画", value: 520 }, { label: "実績", value: 485 }],
                    [{ label: "計画", value: 380 }, { label: "実績", value: 412 }],
                    [{ label: "計画", value: 400 }, { label: "実績", value: 468 }],
                    [{ label: "計画", value: 280 }, { label: "実績", value: 276 }]
                ]
            }
        },
        {
