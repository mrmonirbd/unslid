...
export const Schema = z.object({
    title: z.string().max(8).describe("The main heading of the slide").default("棒グラフ"),
    subtitleLeft: z.string().max(10).describe("Left subtitle text").default("キャンペーンA"),
    subtitleRight: z.string().max(12).describe("Right subtitle text").default("トップキャンペーン"),
    footerLabel: z.string().max(15).describe("Footer label text").default("エンゲージメント率"),
    ...
    graphData: z.object({
        ...
        columns: ["計画予算", "実際予算"],
        rows: [
            { label: "有料SNS", value: 520, value2: 485 },
            { label: "コンテンツ", value: 380, value2: 412 },
            { label: "イベント", value: 450, value2: 468 },
            { label: "SEO", value: 280, value2: 276 }
        ]
    })
});
