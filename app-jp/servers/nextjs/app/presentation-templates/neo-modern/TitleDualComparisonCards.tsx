...
export const Schema = z.object({
    mainTitle: z.string().max(30).describe("The main heading of the slide").default("テキスト比較"),
    comparisonSections: z.array(
        ...
        {
            heading: "課題",
            description: "プレゼンテーションはデモンストレーション、講義、レポートなどに使用できるコミュニケーションツールであり、主に聴衆の前で発表されます。"
        },
        {
            heading: "解決策",
            description: "プレゼンテーションはデモンストレーション、講義、レポートなどに使用できるコミュニケーションツールであり、主に聴衆の前で発表されます。"
