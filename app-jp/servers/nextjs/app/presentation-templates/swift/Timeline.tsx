...
const ItemSchema = z
  .object({
    ...
    heading: z.string().min(3).max(28).default("2020年創業"),
    body: z
      .string()
      .min(10)
      .max(160)
      .default("事業の開始と成長の基盤構築。"),
    icon: IconSchema,
  })
  .default({ year: "2018", heading: "2020年創業", body: "事業の開始と成長の基盤構築。", icon: IconSchema.parse({}) })
...
const Schema = z
  .object({
    ...
    subtitle: z
      ...
      .max(200)
      .default(
        "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力し、持続的な成長を実現してきました。"
      ),
    items: z
      .array(ItemSchema)
      .min(1)
      .max(4)
      .default([
        ItemSchema.parse({ year: "2018", heading: "2020年創業", body: "事業の開始と成長の基盤構築。" }),
        ItemSchema.parse({ year: "2019", heading: "2021年初製品リリース", body: "初製品の市場投入と顧客獲得。" }),
        ItemSchema.parse({ year: "2020", heading: "2022年主要マイルストーン", body: "重要な事業目標の達成と成長加速。" }),
        ItemSchema.parse({ year: "2021", heading: "2024年グローバル展開", body: "国際市場への参入と事業拡大。" }),
      ]),
