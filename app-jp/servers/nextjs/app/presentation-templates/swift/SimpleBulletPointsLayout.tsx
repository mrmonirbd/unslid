...
const PointSchema = z
  .object({
    title: z.string().min(6).max(60).default("タイトル"),
    body: z
      .string()
      .min(30)
      .max(220)
      .default(
        "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力します。"
      ),
  })
  .default({ title: "タイトル", body: "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力します。" })

const Schema = z
  .object({
    title: z.string().min(4).max(36).default("私たちのコミットメント"),
    statement: z
      .string()
      .min(20)
      .max(260)
    ...
    points: z
      ...
      .min(1)
      .max(4)
      .default([PointSchema.parse({}), PointSchema.parse({}), PointSchema.parse({}), PointSchema.parse({ title: "タイトル", body: "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力します。" })]),
    website: z.string().min(6).max(60).default("www.yourwebsite.com"),
  })
  .default({
    title: "イノベーションへのコミットメント",
    statement: "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力します。",
    points: [
      { title: "タイトル", body: "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力します。" },
      { title: "タイトル", body: "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力します。" },
      { title: "タイトル", body: "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力します。" },
      { title: "タイトル", body: "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力します。" },
