...
const MetricSchema = z
  .object({
    ...
    line1: z.string().min(2).max(22).default("合計"),
    line2: z.string().min(0).max(22).default("ユーザー数"),
    description: z
      .string()
      .min(10)
      .max(140)
      .default("複数業界でのアクティブユーザー数"),
  })
  .default({
    value: "10K+",
    line1: "Total",
...
const Schema = z
  .object({
    ...
    leftBody: z
      ...
      .max(220)
      .default(
        "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力し、データを基に実績を証明します。"
      ),
    ...
    metrics: z
      ...
      .default([
        MetricSchema.parse({
          ...
          line1: "合計",
          line2: "ユーザー数",
          description: "複数業界でのアクティブユーザー数",
        }),
        MetricSchema.parse({
          value: "150%",
          line1: "収益",
          line2: "成長率",
          description: "前年比収益成長率",
        }),
        MetricSchema.parse({
          value: "95%",
          line1: "顧客",
          line2: "満足度",
          description: "平均評価4.8/5の顧客維持率",
        }),
      ]),
  })
  .default({
    title: "私たちの実績",
    leftTitle: "データが証明する\n実績",
    leftBody: "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力し、データを基に実績を証明します。",
