...
const FeatureSchema = z
  .object({
    title: z.string().min(4).max(28).default("カスタマイズ可能なワークフロー"),
    body: z
      .string()
      .min(20)
      .max(140)
      .default("テクノロジーセクターを優先した企業向けのソリューションです。"),
    icon: IconSchema,
  })
  .default({
...
const Schema = z
  .object({
    ...
    description: z
      ...
      .max(200)
      .default(
        "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力した製品機能の概要。"
      ),
    features: z
      .array(FeatureSchema)
      .min(3)
