...
const Schema = z
  .object({
    ...
    subtitlePrefix: z.string().min(3).max(40).default("プレゼンテーション"),
    subtitleAccent: z.string().min(3).max(40).default("テンプレート"),
    ...
    paragraph: z
      ...
      .max(200)
      .default(
        "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。"
      ),
  ...
  .default({
    title: "ピッチデッキ",
    subtitlePrefix: "プレゼンテーション",
    subtitleAccent: "テンプレート",
    paragraph:
      "金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。",
