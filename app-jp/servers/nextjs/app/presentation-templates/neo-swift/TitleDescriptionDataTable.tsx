...
export const Schema = z.object({
    title: z.string().max(12).describe("The main title of the slide displayed at the top left").default("テーブル"),
    description: z.string().max(180).describe("The overview description paragraph displayed at the top right").default("金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。"),
    table: z.object({
