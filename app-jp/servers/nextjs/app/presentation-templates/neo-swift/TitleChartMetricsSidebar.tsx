...
export const Schema = z.object({
    title: z.string().max(15).describe("The main title of the slide").default("支出とROI"),
    chartType: chartTypeEnum.describe('Type of chart to display').default('bar'),
    chart: z.object({
        columns: z.array(z.string()).max(2).describe("The labels for the data series, e.g., Revenue and Spend").default(["収益", "支出"]),
        rows: z.array(z.object({
            label: z.string().max(3).describe("The X-axis label, e.g., Month names").default("1月"),
        ...
        columns: ["収益", "支出"],
        rows: [
            { label: "1月", value: 520, value2: 140 },
            { label: "2月", value: 670, value2: 250 },
            { label: "3月", value: 980, value2: 400 },
        ],
    ...
    metrics: z.array(z.object({
        ...
        description: z.string().max(35).describe("Bottom description or challenge text").default("主な課題：クライアント遅延"),
    })).max(4).describe("List of metric cards shown on the right side").default([
        { heading: "調査", value: "8,450", description: "主な課題：クライアント遅延" },
        { heading: "調査", value: "8,450", description: "主な課題：クライアント遅延" },
        { heading: "調査", value: "8,450", description: "主な課題：クライアント遅延" },
        { heading: "調査", value: "8,450", description: "主な課題：クライアント遅延" },
    ]),
