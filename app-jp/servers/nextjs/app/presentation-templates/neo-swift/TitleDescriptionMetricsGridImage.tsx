...
export const Schema = z.object({
    title: z.string().max(25).describe('The main title of the slide').default('画像と説明・指標'),
    description: z.string().max(120).describe('A brief description or context for the slide content').default('金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。$3.5M達成を目標とします。'),
