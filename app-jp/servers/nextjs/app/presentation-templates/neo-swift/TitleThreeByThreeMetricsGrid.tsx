...
export const Schema = z.object({
    title: z.string().max(40).describe('The main title of the slide').default('比較スナップショット'),
    items: z.array(z.object({
        ...
        { label: '調査', value: '8,450', detail: '主な課題：クライアント遅延', isHighlighted: false },
        { label: '調査', value: '8,450', detail: '主な課題：クライアント遅延', isHighlighted: false },
        { label: '調査', value: '8,450', detail: '主な課題：クライアント遅延', isHighlighted: false },
        { label: '調査', value: '8,450', detail: '主な課題：クライアント遅延', isHighlighted: false },
        { label: '調査', value: '8,450', detail: '主な課題：クライアント遅延', isHighlighted: true },
        { label: '調査', value: '8,450', detail: '主な課題：クライアント遅延', isHighlighted: false },
        { label: '調査', value: '8,450', detail: '主な課題：クライアント遅延', isHighlighted: false },
        { label: '調査', value: '8,450', detail: '主な課題：クライアント遅延', isHighlighted: false },
        { label: '調査', value: '8,450', detail: '主な課題：クライアント遅延', isHighlighted: false },
