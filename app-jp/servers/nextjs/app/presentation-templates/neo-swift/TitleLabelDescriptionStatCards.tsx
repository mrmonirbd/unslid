...
export const Schema = z.object({
    title: z.string().max(17).describe("The main heading of the slide").default("エグゼクティブサマリー"),
    label: z.string().max(5).describe("A short subtitle or category label").default("リード"),
    description: z.string().max(205).describe("The primary body text explaining the summary").default("金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。"),
    stats: z.array(z.object({
        ...
        { value: "10K", heading: "ユーザー数", content: "複数業界でのアクティブユーザー数" },
        { value: "90%", heading: "収益成長率", content: "前年比収益成長率" },
        { value: "150%", heading: "顧客満足度", content: "平均評価4.8/5の顧客維持率" }
    ]),
});
