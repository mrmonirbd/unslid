...
export const Schema = z.object({
    title: z.string().max(30).describe('The main title of the slide').default('シンプルな箇条書き'),
    tagline: z.string().max(15).describe('A short tagline or label displayed with a bullet').default('リード'),
    description: z.string().max(300).describe('The main paragraph description on the left side of the slide').default('金融サービス、ヘルスケア、テクノロジーセクターで500名以上の従業員を持つ企業に注力。アカウントベースのマーケティングとコンテンツ主導の戦略により、CACを$150以下に抑えながら$3.5Mの新規パイプラインを目標とします。'),
    steps: z.array(z.object({
        ...
        { title: '注文の受付', description: '顧客がオンラインで商品を選択し、購入を確認します。' },
        { title: '支払い処理', description: 'カード、銀行振込、または電子ウォレットで支払いが行われます。' },
        { title: '注文の検証', description: 'システムが処理前に取引の詳細を確認します。' },
        { title: '梱包段階', description: '商品は配送に向けて安全に梱包されます。' }
    ])
});
