  ...
  return (
    <div className="space-y-6 ">
      ...
      <div className="mb-4 flex items-center justify-between bg-white p-10">
        <div className="">
          <h3 className="text-xl font-normal text-[#191919]">Anthropic APIキー</h3>
          <p className="mt-2 text-sm max-w-[205px] text-gray-500">
            APIキーはローカルに保存され、共有されることはありません
          </p>
        </div>
            ...
            {modelsChecked && availableModels.length === 0 && (
              <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-sm text-yellow-800">
                  モデルが見つかりません。APIキーが有効でAnthropicモデルにアクセスできることを確認してください。
                </p>
              </div>
            )}
      ...
      <div className="bg-white flex justify-between items-center p-10 rounded-[12px]">
        <div>
          <h4 className="text-xl font-normal text-[#191919]">モデル設定</h4>
          <p className="mt-2 text-sm max-w-[205px] text-gray-500">
            ウェブアクセスと高度なAI機能を設定します。
          </p>
        </div>
        <div className="flex items-center gap-4">
