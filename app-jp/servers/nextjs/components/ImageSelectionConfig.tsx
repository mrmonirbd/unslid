...
const DALLE_3_QUALITY_OPTIONS = [
    {
        label: "標準",
        value: "standard",
        description: "低コストで高速生成",
    },
    {
        label: "HD",
        value: "hd",
        description: "コストが高いが高品質な画像",
    },
];
    ...
    return (
        <div className='mt-7'>
            <div className="p-10 flex justify-between items-center bg-white rounded-[12px]">
                <div>
                    <h4 className="text-xl font-normal text-[#191919]">画像生成設定</h4>
                                            ...
                                            <div className=" space-y-4 w-[295px]">
                                                <div>
                                                    ...
                                                    <p className="mt-2 text-sm text-gray-500 flex items-center gap-2">
                                                        ...
                                                        Dockerで実行する際はマシンのIPアドレスを使用してください（localhostではありません）
                                                    </p>
                                                </div>
                                                <div>
                                                    <label className="block text-sm font-medium text-gray-700 mb-2">
                                                    ...
                                                    <p className="mt-2 text-sm text-gray-500">
                                                        ComfyUIから「Export (API)」を使用してワークフローをエクスポートし、JSONをここに貼り付けてください。
                                                    </p>
                                                </div>
                                            </div>
                                        );
