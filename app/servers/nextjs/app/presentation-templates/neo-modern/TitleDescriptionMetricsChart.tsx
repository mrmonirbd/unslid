                    ...
                    <ResponsiveContainer width="100%" height={350}>
                        <LineChart data={chartData?.rows} margin={{ top: 15, right: 30, left: 0, bottom: 0 }}>
                            ...
                            {chartData?.columns?.map((column, index) => (
                                <Line key={column} type="monotone" dataKey={column} name={column} stroke={graphColors(index)} strokeWidth={3} dot={{ r: 5, strokeWidth: 0 }} activeDot={{ r: 7 }} />
                            ))}
                        </LineChart>
                    </ResponsiveContainer>
                );
                ...
                return (
                    <ResponsiveContainer width="100%" height={350}>
                        <BarChart data={chartData?.rows} margin={{ top: 15, right: 30, left: 0, bottom: 0 }}>
                            ...
                            <Legend />
                            {chartData?.columns?.map((column, index) => (
                                <Bar key={column} dataKey={column} name={column} fill={graphColors(index)} radius={[4, 4, 0, 0]}>
                ...
                return (
                    <ResponsiveContainer width="100%" height={350}>
                        <BarChart data={chartData?.rows} layout="vertical" margin={{ top: 15, right: 30, left: 10, bottom: 0 }}>
                            ...
                            <Legend />
                            {chartData?.columns?.map((column, index) => (
                                <Bar key={column} dataKey={column} name={column} fill={graphColors(index)} radius={[0, 4, 4, 0]} />
                            ))}
                        </BarChart>
                    </ResponsiveContainer>
                );
                ...
                return (
                    <ResponsiveContainer width="100%" height={350}>
                        <BarChart data={chartData?.rows} barGap={2} barCategoryGap="20%" margin={{ top: 15, right: 30, left: 0, bottom: 0 }}>
                            ...
                            <Legend />
                            {chartData?.columns?.map((column, index) => (
                                <Bar key={column} dataKey={column} name={column} fill={graphColors(index)} radius={[4, 4, 0, 0]} barSize={30}>
                ...
                return (
                    <ResponsiveContainer width="100%" height={350}>
                        <BarChart data={divergingData} layout="vertical" stackOffset="sign" margin={{ top: 15, right: 30, left: 10, bottom: 0 }}>
                            ...
                            <Legend />
                            {chartData?.columns?.map((column, index) => (
                                <Bar key={column} dataKey="positive" name={column} fill={graphColors(index)} stackId="stack" radius={[0, 4, 4, 0]} />
                ...
                return (
                    <ResponsiveContainer width="100%" height={350}>
                        <AreaChart data={chartData?.rows} margin={{ top: 15, right: 30, left: 0, bottom: 0 }}>
                            ...
                            {chartData?.columns?.map((column, index) => (
                                <Area key={column} type="monotone" dataKey={column} name={column} stroke={graphColors(index)} strokeWidth={2} fill={`url(#metricsArea-${index})`} />
                            ))}
                        </AreaChart>
                    </ResponsiveContainer>
                );
                ...
                return (
                    <ResponsiveContainer width="100%" height={350}>
                        <AreaChart data={chartData?.rows} margin={{ top: 15, right: 30, left: 0, bottom: 0 }}>
                            ...
                            <Legend />
                            {chartData?.columns?.map((column, index) => (
                                <Area key={column} type="monotone" dataKey={column} name={column} stackId="1" stroke={graphColors(index)} fill={graphColors(index)} fillOpacity={0.5} />
                            ))}
                        </AreaChart>
                    </ResponsiveContainer>
                );
