...
const LegalPage = ({ eyebrow, title, description, sections }: LegalPageProps) => {
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(124,58,237,0.08),transparent_32%),linear-gradient(180deg,#fbf9ff_0%,#ffffff_48%,#f8fafc_100%)] text-slate-950">
